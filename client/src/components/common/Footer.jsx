...
const Footer = () => (
    <footer className="relative bg-white dark:bg-zinc-950 overflow-hidden">
        ...
        {/* Razor glow on top edge */}
        <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-orange-500/60 to-transparent" />
        <div className="absolute -top-8 left-1/2 -translate-x-1/2 w-80 h-16 bg-orange-500/10 blur-3xl rounded-full pointer-events-none" />
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-6 py-8
            ...
            <Link to="/" className="group shrink-0">
                <span className="font-rye text-2xl tracking-tight text-gray-900 dark:text-white
            ...
            <nav className="flex items-center">
                {NAV.map(({ to, label }, i) => (
                    <span key={to} className="flex items-center">
                        ...
                        {i < NAV.length - 1 && (
                            <span className="text-gray-400 dark:text-white/20 select-none text-xs">·</span>
                        )}
                    </span>
                ))}
            </nav>

            {/* Social icons — size kept at 16 */}
        ...
        <div className="border-t border-gray-100 dark:border-white/[0.04]">
            <div className="max-w-screen-xl mx-auto px-6 py-3
                ...
                <p className="text-[11px] text-gray-500 dark:text-gray-400 tracking-wide">
                    © {new Date().getFullYear()} OpenPage — All rights reserved.
                </p>

                <p className="text-[11px] text-gray-500 dark:text-gray-400 tracking-wide flex items-center gap-1.5">
                    Crafted by&nbsp;
                    {/* DevTrix — gradient glow badge */}
                    <span
                        className="inline-flex items-center px-2.5 py-0.5 rounded-full
                                   text-[11px] font-black tracking-widest uppercase
                                   ring-1 ring-orange-400/50 dark:ring-orange-500/40
