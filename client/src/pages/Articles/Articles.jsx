    ...
    return (
        <div className="bg-zinc-950 min-h-screen">
            <Helmet>
                ...
                <meta name="description" content="Browse all approved articles on OpenPage." />
            </Helmet>
            ...
            <div className="bg-zinc-900 border-b border-white/[0.06] py-10 sm:py-14">
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 text-center">
                    <p className="text-orange-400 text-xs font-semibold uppercase tracking-widest mb-3">Browse</p>
                    <h1 className="text-3xl sm:text-4xl font-bold text-white mb-6">All Articles</h1>
            ...
            <Container>
                <div className="py-10 sm:py-14">
                    {articles && articles.length > 0 ? (
                        <>
                            <p className="text-gray-500 text-sm mb-6">{articles.length} article{articles.length !== 1 ? "s" : ""} found</p>
